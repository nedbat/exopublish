...
| [2u-arch-bom](#team-2u-arch-bom) | 204 | [edx&#x2011;platform](#-openedxedx-platform)&nbsp;146; [devstack](#-openedxdevstack)&nbsp;17; [edx&#x2011;repo&#x2011;health](#-openedxedx-repo-health)&nbsp;5; [repo&#x2011;tools](#-openedxrepo-tools)&nbsp;4; [edx&#x2011;cookiecutters](#-openedxedx-cookiecutters)&nbsp;4; [event&#x2011;routing&#x2011;backends](#-openedxevent-routing-backends)&nbsp;3; [edx&#x2011;lint](#-openedxedx-lint)&nbsp;3; [django&#x2011;user&#x2011;tasks](#-openedxdjango-user-tasks)&nbsp;3; [edx&#x2011;rbac](#-openedxedx-rbac)&nbsp;2; [edx&#x2011;django&#x2011;utils](#-openedxedx-django-utils)&nbsp;2; [django&#x2011;config&#x2011;models](#-openedxdjango-config-models)&nbsp;2; [auth&#x2011;backends](#-openedxauth-backends)&nbsp;2; [api&#x2011;manager](#-edxapi-manager)&nbsp;2; [xss&#x2011;utils](#-openedxxss-utils)&nbsp;1; [web&#x2011;fragments](#-openedxweb-fragments)&nbsp;1; [pytest&#x2011;warnings&#x2011;report](#-openedxpytest-warnings-report)&nbsp;1; [help&#x2011;tokens](#-openedxhelp-tokens)&nbsp;1; [edx&#x2011;toggles](#-openedxedx-toggles)&nbsp;1; [django&#x2011;splash](#-openedxdjango-splash)&nbsp;1; [django&#x2011;pyfs](#-openedxdjango-pyfs)&nbsp;1; [bok&#x2011;choy](#-openedxbok-choy)&nbsp;1; [edx&#x2011;arch&#x2011;experiments](#-edxedx-arch-experiments)&nbsp;1 |
| [2u-aurora](#team-2u-aurora) | 62 | [frontend&#x2011;app&#x2011;learning](#-openedxfrontend-app-learning)&nbsp;22; [frontend&#x2011;app&#x2011;gradebook](#-openedxfrontend-app-gradebook)&nbsp;12; [edx&#x2011;ora2](#-openedxedx-ora2)&nbsp;9; [frontend&#x2011;app&#x2011;learner&#x2011;dashboard](#-openedxfrontend-app-learner-dashboard)&nbsp;8; [frontend&#x2011;app&#x2011;ora&#x2011;grading](#-openedxfrontend-app-ora-grading)&nbsp;5; [super&#x2011;csv](#-openedxsuper-csv)&nbsp;3; [frontend&#x2011;app&#x2011;ora](#-openedxfrontend-app-ora)&nbsp;1; [edx&#x2011;submissions](#-openedxedx-submissions)&nbsp;1; [edx&#x2011;bulk&#x2011;grades](#-openedxedx-bulk-grades)&nbsp;1 |
...
| [2u-infinity](#team-2u-infinity) | 15 | [frontend&#x2011;app&#x2011;discussions](#-openedxfrontend-app-discussions)&nbsp;7; [frontend&#x2011;app&#x2011;communications](#-openedxfrontend-app-communications)&nbsp;4; [cs_comments_service](#-openedxcs-comments-service)&nbsp;4 |
...
| [2u-phoenix](#team-2u-phoenix) | 17 | [frontend&#x2011;app&#x2011;support&#x2011;tools](#-openedxfrontend-app-support-tools)&nbsp;7; [frontend&#x2011;app&#x2011;publisher](#-openedxfrontend-app-publisher)&nbsp;7; [course&#x2011;discovery](#-openedxcourse-discovery)&nbsp;2; [reactifex](#-openedxreactifex)&nbsp;1 |
...
- 2023-10-14 [feat!: remove Transifex calls for OEP-58 \| FC-0012](https://github.com/openedx/frontend-app-learner-record/pull/200) (hopewise) [*blocked by other work; open-source-contribution*]

### [#](#-openedxfrontend-app-profile) [openedx/frontend-app-profile](https://github.com/openedx/frontend-app-profile/pulls)
- 2023-05-31 [[Do Not Merge] build: demonstrate using localhost.stage.edx.org](https://github.com/openedx/frontend-app-profile/pull/763) (adamstankiewicz)
- 2023-06-04 [[do not merge] DEMO: design tokens and CSS variables](https://github.com/openedx/frontend-app-profile/pull/764) (adamstankiewicz)
...
- 2023-10-18 [chore: bumped frontend-platform with relavent edx packages](https://github.com/openedx/frontend-app-profile/pull/881) (BilalQamar95)
- 2023-10-21 [feat!: remove Transifex calls for OEP-58 \| FC-0012](https://github.com/openedx/frontend-app-profile/pull/889) (hopewise) [*blocked by other work; open-source-contribution*]
...
- 2023-10-25 [Ci tests](https://github.com/edx/api-manager/pull/243) (bszabo)
...
- 2023-08-30 [feat: Add manufacture_data django command](https://github.com/edx/edx-arch-experiments/pull/426) (marlonkeating)
...
- 2022-01-24 [chore: add reserved keywords linter](https://github.com/openedx/auth-backends/pull/166) (arbabkhalil)
...
- 2023-06-12 [feat: Updated devstack mysql 5.7 to 8](https://github.com/openedx/devstack/pull/1094) (farhanumar)
- 2023-06-15 [chore: credentials pointing to mysql8 container](https://github.com/openedx/devstack/pull/1098) (farhanumar)
...
- 2023-10-03 [docs: update troubleshoot_general_tips.rst](https://github.com/openedx/devstack/pull/1194) (Guilleves)
- 2023-10-10 [Switch to Ansible-Free Docker Image of cs_comments_service(forums)](https://github.com/openedx/devstack/pull/1205) (irtazaakram)
...
- 2022-01-25 [chore: add reserved keywords linter](https://github.com/openedx/django-config-models/pull/197) (arbabkhalil)
...
- 2021-06-07 [Revert "chore: disabling the fail_ci_if_error temporarily."](https://github.com/openedx/django-user-tasks/pull/154) (awais786)
- 2023-08-04 [fix: unpin pyyaml](https://github.com/openedx/django-user-tasks/pull/298) (salman2013)
...
- 2022-02-22 [build: Fixed tests cases](https://github.com/openedx/edx-cookiecutters/pull/175) (awais786)
- 2022-08-15 [build: docker tweaks](https://github.com/openedx/edx-cookiecutters/pull/246) (m-pitera)
- 2022-09-28 [chore: Add Dockerfile linter](https://github.com/openedx/edx-cookiecutters/pull/265) (adzuci)
- 2022-09-28 [chore: Add Hadolint Dockerfile Linter POC](https://github.com/openedx/edx-cookiecutters/pull/267) (adzuci)

### [#](#-openedxedx-django-utils) [openedx/edx-django-utils](https://github.com/openedx/edx-django-utils/pulls)
- 2022-05-12 [build: Adding django40 testing in ci.](https://github.com/openedx/edx-django-utils/pull/213) (awais786)
...
- 2021-04-05 [feat: added commitlint configuration file for global use](https://github.com/openedx/edx-lint/pull/152) (iamsobanjaved)
- 2021-09-07 [feat: add script to resolve common constraint](https://github.com/openedx/edx-lint/pull/193) (iamsobanjaved)
...
- 2019-07-18 [Bumped edx-enterprise version](https://github.com/openedx/edx-platform/pull/21157) (ziafazal)
...
- 2020-05-21 [WS-993 update catalog search links to point to new search.](https://github.com/openedx/edx-platform/pull/24049) (reillz10)
- 2020-07-17 [Teamset term](https://github.com/openedx/edx-platform/pull/24531) (muselesscreator)
- 2020-08-20 [draft: docs: add page_number_paginate_serializer](https://github.com/openedx/edx-platform/pull/24821) (kdmccormick)
...
- 2020-11-16 [AA-303: Celebrate a user's first ever discussion post!](https://github.com/openedx/edx-platform/pull/25606) (Dillon-Dumesnil)
- 2021-03-04 [upgrade edx-enterprise to 3.17.46](https://github.com/openedx/edx-platform/pull/26855) (sameenfatima78)
- 2021-03-16 [feat: adds modal to direct enterprise learners to LP from dashboard](https://github.com/openedx/edx-platform/pull/27033) (chavesj)
- 2021-04-02 [Add CodeQL linting to PRs](https://github.com/openedx/edx-platform/pull/27234) (adzuci)
- 2021-04-07 [refactor: extract single username gradebook fetch](https://github.com/openedx/edx-platform/pull/27263) (binodpant)
...
- 2021-05-31 [fix: increase grading rounding precision to avoid incorrect grades](https://github.com/openedx/edx-platform/pull/27788) (Agrendalath) [*open-source-contribution; product review*]
...
- 2021-07-07 [feat: add functionality to create honor course modes through studio](https://github.com/openedx/edx-platform/pull/28114) (mariajgrimaldi) [*open-source-contribution; awaiting prioritization; product review; core committer*]
- 2021-07-13 [feat: Make courseware URLs more human-readable](https://github.com/openedx/edx-platform/pull/28174) (KristinAoki)
- 2021-08-02 [Adding drf ext new commit](https://github.com/openedx/edx-platform/pull/28343) (awais786)
- 2021-08-02 [feat: class override decorator (AA-268)](https://github.com/openedx/edx-platform/pull/28370) (sofiayoon)
- 2021-08-10 [feat: implement usage_key_hashes and expose via sequence metadata api](https://github.com/openedx/edx-platform/pull/28436) (kdmccormick)
...
- 2021-11-01 [fix: consider course end date in visible_date](https://github.com/openedx/edx-platform/pull/29187) (oliviaruizknott)
...
- 2021-12-16 [TEMP Iamsobanjaved/test regis change](https://github.com/openedx/edx-platform/pull/29629) (iamsobanjaved)
- 2022-01-05 [fix: Incorrect country value not accepted on registration form](https://github.com/openedx/edx-platform/pull/29710) (sameenfatima78)
- 2022-01-31 [Iamosbanjaved/chk flaky tests](https://github.com/openedx/edx-platform/pull/29845) (iamsobanjaved)
...
- 2022-08-23 [Qa/bd 39](https://github.com/openedx/edx-platform/pull/30891) (leangseu-edx)
...
- 2022-09-12 [Test adding fsevents](https://github.com/openedx/edx-platform/pull/30979) (brian-smith-tcril)
- 2022-10-13 [BD-39 modernize paragon for edx-platform](https://github.com/openedx/edx-platform/pull/31153) (leangseu-edx)
- 2022-10-18 [Lk/bd 39](https://github.com/openedx/edx-platform/pull/31164) (leangseu-edx)
- 2022-10-19 [refactor: cleanup moderation roles attribute in discussions course endpoint](https://github.com/openedx/edx-platform/pull/31169) (saadyousafarbi)
- 2022-10-19 [build: add actions version updater](https://github.com/openedx/edx-platform/pull/31170) (aht007)
- 2022-10-20 [Leangseu edx/bd 39 new](https://github.com/openedx/edx-platform/pull/31186) (leangseu-edx)
...
- 2022-11-23 [feat: adds openedx-filter hook to the course enrollments site](https://github.com/openedx/edx-platform/pull/31331) (JuanDavidBuitrago) [*open-source-contribution*]
...
- 2023-03-03 [chore: bump postcss, css-loader and rtlcss](https://github.com/openedx/edx-platform/pull/31872) (BilalQamar95)
- 2023-03-20 [feat: upgraded to node v18, added .nvmrc and updated workflows](https://github.com/openedx/edx-platform/pull/31963) (Mashal-m)
...
- 2023-03-31 [feat: adds TenantAwareLinkRenderStarted filter](https://github.com/openedx/edx-platform/pull/32014) (JuanDavidBuitrago) [*open-source-contribution; blocked by other work*]
- 2023-04-04 [feat: add message for invalid assignment type](https://github.com/openedx/edx-platform/pull/32029) (KristinAoki)
- 2023-04-11 [feat: Add ID to enrollment event bus events.](https://github.com/openedx/edx-platform/pull/32051) (macdiesel)
- 2023-04-12 [feat: Enable courseware search on old about page](https://github.com/openedx/edx-platform/pull/32066) (schenedx)
- 2023-04-12 [feat: initial whisper transcript api construction](https://github.com/openedx/edx-platform/pull/32067) (KristinAoki)
...
- 2023-05-12 [Ali abbas/apply eslint amnesty](https://github.com/openedx/edx-platform/pull/32226) (Syed-Ali-Abbas-Zaidi)
- 2023-05-19 [feat: cache course data](https://github.com/openedx/edx-platform/pull/32271) (muhammad-ammar)
- 2023-05-24 [Jkantor/test migrations test](https://github.com/openedx/edx-platform/pull/32301) (jansenk)
- 2023-05-30 [docs: updating extension_points.rst](https://github.com/openedx/edx-platform/pull/32329) (kdmccormick)
- 2023-06-09 [feat: default grade designations configurable from settings](https://github.com/openedx/edx-platform/pull/32406) (kaustavb12) [*open-source-contribution; product review*]
- 2023-06-13 [fix: allow only enrolled users in course forum related roles](https://github.com/openedx/edx-platform/pull/32436) (navinkarkera) [*open-source-contribution; waiting for eng review*]
- 2023-06-15 [feat: remove learner home redirect percentage](https://github.com/openedx/edx-platform/pull/32482) (nsprenkle)
...
- 2023-06-30 [feat: ADR for video and file folders](https://github.com/openedx/edx-platform/pull/32615) (KristinAoki)
...
- 2023-07-03 [fix: cache moderniser results pushed for initial testing](https://github.com/openedx/edx-platform/pull/32630) (zubairshakoorarbisoft)
...
- 2023-07-09 [build: consolidate xmodule/js into xmodule/assets (WIP)](https://github.com/openedx/edx-platform/pull/32691) (kdmccormick)
...
- 2023-07-14 [backport: feat: add ability to notify credentials about honor certificates](https://github.com/openedx/edx-platform/pull/32745) (DmytroAlipov) [*open-source-contribution; product review; backport*]
- 2023-07-21 [feat: add flag to stop using default css](https://github.com/openedx/edx-platform/pull/32810) (leangseu-edx)
- 2023-07-24 [feat: due date reminder](https://github.com/openedx/edx-platform/pull/32826) (navinkarkera) [*open-source-contribution; product review*]
...
- 2023-08-08 [feat!: add zoom live conference calls settings at organization level](https://github.com/openedx/edx-platform/pull/32942) (Faraz32123)
...
- 2023-10-16 [feat: FC-0012 - add atlas pull behind a flag](https://github.com/openedx/edx-platform/pull/33502) (shadinaif) [*open-source-contribution*]
- 2023-10-16 [fix: support for newer npm and macOS](https://github.com/openedx/edx-platform/pull/33506) (kdmccormick)
- 2023-10-16 [feat: add extra fields to ORA staff graded serializer](https://github.com/openedx/edx-platform/pull/33507) (nandodev-net) [*open-source-contribution*]
- 2023-10-16 [chore: updating default algorithm to sha256.](https://github.com/openedx/edx-platform/pull/33510) (awais786)
...
- 2023-10-23 [Try ruff linter](https://github.com/openedx/edx-platform/pull/33559) (irtazaakram)
...
- 2023-10-24 [Unpin Pylint](https://github.com/openedx/edx-platform/pull/33567) (irtazaakram)
...
- 2023-10-24 [Read support for v2 library content using openedx-learning models](https://github.com/openedx/edx-platform/pull/33579) (ormsbee)
...
- 2023-10-27 [create course_roles on django admin dashboard](https://github.com/openedx/edx-platform/pull/33607) (hsinkoff)
- 2023-10-27 [feat: course_roles setup](https://github.com/openedx/edx-platform/pull/33609) (hsinkoff)
...
- 2023-11-01 [Check any migrations change](https://github.com/openedx/edx-platform/pull/33636) (awais786)
...
- 2023-11-02 [fix: youtube race condition when GTM loads](https://github.com/openedx/edx-platform/pull/33650) (viadanna) [*open-source-contribution; backport*]
...
- 2023-02-24 [[IDEA] feat: add a helper function to generate a django-rules predicate](https://github.com/openedx/edx-rbac/pull/208) (pwnage101)
...
- 2023-10-27 [feat: allow to use any configured engine to replay tracking logs](https://github.com/openedx/event-routing-backends/pull/362) (Ian2012) [*open-source-contribution*]

### [#](#-openedxhelp-tokens) [openedx/help-tokens](https://github.com/openedx/help-tokens/pulls)
- 2022-01-26 [chore: add reserved keywords linter](https://github.com/openedx/help-tokens/pull/46) (arbabkhalil)
...
- 2021-09-07 [feat: add script to resolve common constraint](https://github.com/openedx/repo-tools/pull/203) (iamsobanjaved)
...
- 2023-08-11 [feat: sync metadata from catalog-info.yaml with repo_checks (WIP)](https://github.com/openedx/repo-tools/pull/428) (kdmccormick)
...
- 2023-08-03 [chore: bump the version.](https://github.com/openedx/edx-ora2/pull/2015) (awais786)
- 2023-08-09 [chore: bump version for new release](https://github.com/openedx/edx-ora2/pull/2023) (iamsobanjaved)
- 2023-08-09 [feat: selectable students waiting step](https://github.com/openedx/edx-ora2/pull/2025) (johnvente) [*open-source-contribution; waiting on author; product review*]
- 2023-09-26 [[Django 4.2]: Upgrade Django to 4.2](https://github.com/openedx/edx-ora2/pull/2057) (irtazaakram)
- 2023-10-16 [feat: add extra fields to ORA staff graded serializer](https://github.com/openedx/edx-ora2/pull/2076) (nandodev-net) [*open-source-contribution; waiting on author; inactive*]
- 2023-10-20 [fix: try calling set_code_owner inside task](https://github.com/openedx/edx-ora2/pull/2084) (rgraber)
...
- 2023-09-12 [feat: add support for design tokens and CSS variables](https://github.com/openedx/frontend-app-gradebook/pull/351) (xitij2000) [*open-source-contribution*]
- 2023-09-27 [feat!: remove Transifex calls for OEP-58](https://github.com/openedx/frontend-app-gradebook/pull/353) (hopewise) [*open-source-contribution; blocked by other work*]
...
- 2023-10-25 [feat: bumped frontend-platform to v6](https://github.com/openedx/frontend-app-gradebook/pull/368) (BilalQamar95)
...
- 2023-07-05 [feat: executive education card related changes for dashboard](https://github.com/openedx/frontend-app-learner-dashboard/pull/171) (bilaltahir21)
- 2023-07-24 [build: update frontend build](https://github.com/openedx/frontend-app-learner-dashboard/pull/180) (Mashal-m) [*needs maintainer attention*]
- 2023-08-25 [refactor: updated lock file version check to use new workflow](https://github.com/openedx/frontend-app-learner-dashboard/pull/200) (Mashal-m) [*waiting on author; needs maintainer attention*]
- 2023-10-21 [feat!: remove Transifex calls for OEP-58 \| FC-0012](https://github.com/openedx/frontend-app-learner-dashboard/pull/227) (hopewise) [*blocked by other work; open-source-contribution; needs maintainer attention*]
- 2023-10-25 [runtime config work](https://github.com/openedx/frontend-app-learner-dashboard/pull/231) (httpsmenahassan) [*needs maintainer attention*]
...
- 2021-10-08 [feat: remove jumpnav-flags](https://github.com/openedx/frontend-app-learning/pull/678) (connorhaugh)
...
- 2023-10-27 [fix: wrong text-color class and text contrast on dates page](https://github.com/openedx/frontend-app-learning/pull/1229) (ihor-romaniuk) [*open-source-contribution; waiting for eng review; backport*]

### [#](#-openedxfrontend-app-ora) [openedx/frontend-app-ora](https://github.com/openedx/frontend-app-ora/pulls)
- 2023-08-25 [refactor: update lock file version](https://github.com/openedx/frontend-app-ora/pull/23) (Mashal-m)
...
- 2023-10-20 [feat!: remove Transifex calls for OEP-58 \| FC-0012](https://github.com/openedx/frontend-app-ora-grading/pull/278) (hopewise) [*blocked by other work; open-source-contribution*]
- 2023-10-25 [feat: bumped frontend-platform to v6](https://github.com/openedx/frontend-app-ora-grading/pull/282) (BilalQamar95)
...
- 2022-04-04 [yaml lint](https://github.com/openedx/super-csv/pull/98) (aht007)
- 2022-09-06 [feat: improve requirements file structure](https://github.com/openedx/super-csv/pull/116) (aht007)
...
- 2023-10-19 [feat: bumped frontend-platform along with relative packages](https://github.com/edx/frontend-lib-learning-assistant/pull/32) (BilalQamar95)
...
- 2021-08-30 [Iamsobanjaved/dokcker fix](https://github.com/openedx/edx-analytics-dashboard/pull/1168) (iamsobanjaved)
- 2022-01-24 [chore: add reserved keywords linter](https://github.com/openedx/edx-analytics-dashboard/pull/1247) (arbabkhalil)
- 2022-04-13 [test: fixing trans.](https://github.com/openedx/edx-analytics-dashboard/pull/1287) (awais786)
- 2022-04-18 [build: add support for node 16](https://github.com/openedx/edx-analytics-dashboard/pull/1291) (iamsobanjaved)
- 2022-04-26 [Migrate eslint](https://github.com/openedx/edx-analytics-dashboard/pull/1299) (aht007)
- 2022-09-28 [chore: Add Dockerfile linter](https://github.com/openedx/edx-analytics-dashboard/pull/1366) (adzuci)
...
- 2023-03-22 [feat: upgraded to node v18, added .nvmrc and updated workflows](https://github.com/openedx/edx-analytics-dashboard/pull/1431) (Mashal-m)
- 2023-09-04 [docs: updated readme](https://github.com/openedx/edx-analytics-dashboard/pull/1492) (abdullahwaheed)
...
### [#](#-openedxedx-analytics-data-api) [openedx/edx-analytics-data-api](https://github.com/openedx/edx-analytics-data-api/pulls)
- 2022-01-25 [chore: add reserved keywords linter](https://github.com/openedx/edx-analytics-data-api/pull/521) (arbabkhalil)
- 2022-07-12 [chore: upgrade packages to bring in edx-enterprise-data 4.5.1](https://github.com/openedx/edx-analytics-data-api/pull/569) (adamstankiewicz)
...
- 2021-06-10 [chore: pip is not working properly and giving conflicts error giving …](https://github.com/openedx/edx-proctoring/pull/882) (awais786)
- 2022-01-26 [chore: add reserved keywords linter](https://github.com/openedx/edx-proctoring/pull/1022) (arbabkhalil)
- 2022-03-14 [feat: Upgrading transifex client and changing configuration.](https://github.com/openedx/edx-proctoring/pull/1032) (awais786)
...
- 2023-10-25 [chore: bumped frontend-platform version](https://github.com/openedx/frontend-app-learner-portal-programs/pull/291) (BilalQamar95)
...
- 2023-10-14 [feat!: remove Transifex calls for OEP-58 \| FC-0012](https://github.com/openedx/frontend-app-program-console/pull/142) (hopewise) [*blocked by other work; open-source-contribution*]
- 2023-10-25 [chore: bumped frontend-platform to v6](https://github.com/openedx/frontend-app-program-console/pull/146) (BilalQamar95)
...
- 2023-10-25 [feat: bumped frontend-platform to v6](https://github.com/openedx/frontend-lib-special-exams/pull/123) (BilalQamar95)
...
- 2020-08-12 [WIP: Implement decentralized devstack](https://github.com/openedx/registrar/pull/341) (katenels)
...
- 2020-12-04 [Record filter](https://github.com/edx/edx-prefectutils/pull/12) (HassanJaveed84)
- 2021-11-15 [feat: Add logic to enable loading pepped events into Amplitude](https://github.com/edx/edx-prefectutils/pull/52) (pwnage101)
...
### [#](#-edxsnowflake-timetravel-table) [edx/snowflake_timetravel_table](https://github.com/edx/snowflake_timetravel_table/pulls)
...
- 2015-05-21 [Add tool for performing curation.](https://github.com/openedx/edx-analytics-pipeline/pull/107) (brianhw)
- 2016-12-28 [Support a dockerized analyticstack](https://github.com/openedx/edx-analytics-pipeline/pull/337) (mulby)
- 2017-06-19 [Collect blast information from SailThru](https://github.com/openedx/edx-analytics-pipeline/pull/409) (brianhw)
- 2017-09-29 [Upgrade some less-problematic packages](https://github.com/openedx/edx-analytics-pipeline/pull/432) (brianhw)
...
- 2019-09-13 [We are using Hive 2.1.1 and NULLIF is supported in 2.3.0 onwards](https://github.com/openedx/edx-analytics-pipeline/pull/758) (ziafazal)
...
- 2020-03-10 [WIP: ENT-2664 added task for inserting course_structure to mysql](https://github.com/openedx/edx-analytics-pipeline/pull/807) (irfanuddinahmad)
- 2020-04-17 [Add partitioning for JSON output.](https://github.com/openedx/edx-analytics-pipeline/pull/814) (brianhw)
- 2020-06-25 [Removed all BigQuery related code.](https://github.com/openedx/edx-analytics-pipeline/pull/819) (HassanJaveed84)
- 2020-11-23 [Removed overwrite parameter from sqoop import tasks](https://github.com/openedx/edx-analytics-pipeline/pull/845) (HassanJaveed84)
...
- 2023-06-15 [[BD-46] feat: added support Paragon design tokens](https://github.com/edx/frontend-component-footer-edx/pull/294) (PKulkoRaccoonGang)
...
- 2023-06-22 [[BD-46] feat: added support Paragon design tokens](https://github.com/edx/frontend-component-header-edx/pull/393) (PKulkoRaccoonGang)
...
- 2023-08-28 [feat: add support for design tokens and CSS variables](https://github.com/openedx/frontend-app-account/pull/862) (xitij2000) [*open-source-contribution*]
- 2023-09-29 [remove Transifex calls for OEP-58](https://github.com/openedx/frontend-app-account/pull/887) (hopewise) [*blocked by other work; open-source-contribution*]
...
- 2023-10-31 [chore: Update to the new version of paragon in the new scope.](https://github.com/openedx/frontend-app-account/pull/931) (feanil)
...
- 2023-07-28 [[do not merge] alpha -> master](https://github.com/openedx/frontend-build/pull/429) (adamstankiewicz)
- 2023-10-24 [[do not merge] experimental alpha -> master](https://github.com/openedx/frontend-build/pull/474) (marlonkeating)
...
- 2023-06-15 [[BD-46] feat: added support Paragon design tokens](https://github.com/openedx/frontend-component-footer/pull/303) (PKulkoRaccoonGang) [*blended*]
- 2023-10-21 [feat!: remove Transifex calls for OEP-58 \| FC-0012](https://github.com/openedx/frontend-component-footer/pull/355) (hopewise) [*blocked by other work; open-source-contribution*]
...
- 2023-06-15 [[BD-46] feat: added support Paragon design tokens](https://github.com/openedx/frontend-component-header/pull/351) (PKulkoRaccoonGang) [*blended*]
- 2023-10-21 [feat!: remove Transifex calls for OEP-58 \| FC-0012](https://github.com/openedx/frontend-component-header/pull/416) (hopewise) [*blocked by other work; open-source-contribution*]
...
- 2023-02-15 [feat: adds support for loading external theme CSS for MFEs](https://github.com/openedx/frontend-platform/pull/440) (adamstankiewicz)
...
- 2020-02-08 [Update dead link.](https://github.com/openedx/cs_comments_service/pull/300) (adzuci)
- 2020-11-20 [AA-303: Adding endpoint to return if a user has ever posted](https://github.com/openedx/cs_comments_service/pull/335) (Dillon-Dumesnil)
...
- 2023-10-24 [feat: bumped frontend-platform to v6](https://github.com/openedx/frontend-app-communications/pull/169) (BilalQamar95)
...
- 2023-10-11 [feat: Profile image on user posts](https://github.com/openedx/frontend-app-discussions/pull/574) (vladislavkeblysh) [*product review; waiting on author; open-source-contribution*]
...
- 2023-10-16 [feat: Editor bar visibility (palm.master)](https://github.com/openedx/frontend-app-discussions/pull/581) (vladislavkeblysh) [*waiting on author; open-source-contribution; backport*]
- 2023-10-16 [feat: Editor bar visibility](https://github.com/openedx/frontend-app-discussions/pull/582) (vladislavkeblysh) [*waiting on author; open-source-contribution*]
- 2023-10-16 [feat: Editor bar visibility (quince.master)](https://github.com/openedx/frontend-app-discussions/pull/583) (vladislavkeblysh) [*waiting on author; open-source-contribution; backport*]
- 2023-10-20 [feat!: remove Transifex calls for OEP-58 \| FC-0012](https://github.com/openedx/frontend-app-discussions/pull/586) (hopewise) [*blocked by other work; open-source-contribution*]
...
- 2021-05-02 [Create testflight.yml](https://github.com/openedx/edx-app-ios/pull/1498) (colinbrash)
...
- 2023-10-17 [chore: coverage test](https://github.com/openedx/frontend-app-publisher/pull/915) (Syed-Ali-Abbas-Zaidi)
...
- 2023-04-10 [feat: catalog curation routes](https://github.com/openedx/frontend-app-support-tools/pull/318) (brobro10000)
...
- 2023-10-14 [feat!: remove Transifex calls for OEP-58 \| FC-0012](https://github.com/openedx/frontend-app-support-tools/pull/361) (hopewise) [*blocked by other work; open-source-contribution*]

### [#](#-openedxreactifex) [openedx/reactifex](https://github.com/openedx/reactifex/pulls)
...
### [#](#-edxpy-opt-cli) [edx/py-opt-cli](https://github.com/edx/py-opt-cli/pulls)
- 2020-12-14 [Update base image to use python:3.8](https://github.com/edx/py-opt-cli/pull/17) (adzuci)
...
- 2023-09-06 [temp: add django42 GHA ahead of actual changes](https://github.com/openedx/ecommerce/pull/4026) (christopappas)
...
- 2023-10-14 [feat!: remove Transifex calls for OEP-58 \| FC-0012](https://github.com/openedx/frontend-app-ecommerce/pull/341) (hopewise) [*blocked by other work; open-source-contribution*]
- 2023-10-26 [chore: bumped frontend-platform to v6 with respective edx packages](https://github.com/openedx/frontend-app-ecommerce/pull/345) (BilalQamar95)
...
- 2023-10-21 [feat!: remove Transifex calls for OEP-58 \| FC-0012](https://github.com/openedx/frontend-app-payment/pull/820) (hopewise) [*blocked by other work; open-source-contribution*]
- 2023-10-26 [chore: bumped frontend-platform to v6 with respective edx packages](https://github.com/openedx/frontend-app-payment/pull/822) (BilalQamar95)
...
- 2023-10-30 [feat: job to remove events of retired users.](https://github.com/edx/jenkins-job-dsl/pull/1693) (Hamza442)
...
- 2023-10-19 [fix: retirement pipeline pip version](https://github.com/openedx/configuration/pull/7046) (dyudyunov) [*open-source-contribution*]
- 2023-10-19 [fix: retirement pipeline pip version](https://github.com/openedx/configuration/pull/7047) (dyudyunov) [*open-source-contribution; waiting for eng review; backport*]
...
### [#](#-edxbraze-client) [edx/braze-client](https://github.com/edx/braze-client/pulls)
- 2022-11-26 [Updating client.py with audience keyword and modifying the recipient keyword](https://github.com/edx/braze-client/pull/11) (zizytd) [*open-source-contribution*]

### [#](#-openedxcypress-e2e-tests) [openedx/cypress-e2e-tests](https://github.com/openedx/cypress-e2e-tests/pulls)
- 2019-07-24 [Awais/code management multiple by multiple](https://github.com/openedx/cypress-e2e-tests/pull/23) (aghaawais01)
- 2019-10-28 [apply typescript](https://github.com/openedx/cypress-e2e-tests/pull/39) (kashifch)
- 2020-09-24 [github actions](https://github.com/openedx/cypress-e2e-tests/pull/47) (aghaawais01)
- 2020-10-21 [typos](https://github.com/openedx/cypress-e2e-tests/pull/50) (aghaawais01)
- 2021-02-01 [Edx abolger/local e2e](https://github.com/openedx/cypress-e2e-tests/pull/63) (edx-abolger)
- 2021-05-17 [test commit](https://github.com/openedx/cypress-e2e-tests/pull/79) (aghaawais01)
- 2021-08-03 [PROD-2388: Logistration Test caes](https://github.com/openedx/cypress-e2e-tests/pull/84) (aghaawais01)

### [#](#-openedxedx-django-sites-extensions) [openedx/edx-django-sites-extensions](https://github.com/openedx/edx-django-sites-extensions/pulls)
- 2022-01-18 [chore: add reserved keywords linter](https://github.com/openedx/edx-django-sites-extensions/pull/40) (arbabkhalil)
- 2023-09-19 [docs: remove the duplicated term in a comment](https://github.com/openedx/edx-django-sites-extensions/pull/51) (emoffett) [*open-source-contribution; inactive*]
...
- 2023-05-24 [feat: course metadata overrides](https://github.com/openedx/edx-enterprise/pull/1760) (muhammad-ammar)
- 2023-06-22 [feat: add button to retransmit courses metadata](https://github.com/openedx/edx-enterprise/pull/1776) (katrinan029)
- 2023-07-04 [feat: adds attribute to hide course prices when zero](https://github.com/openedx/edx-enterprise/pull/1788) (tecoholic) [*open-source-contribution; waiting for eng review*]
- 2023-07-05 [feat: handle enrollments for "Invite Only" courses](https://github.com/openedx/edx-enterprise/pull/1790) (e0d)
- 2023-07-06 [feat: discovery work into implementing integrated skills content](https://github.com/openedx/edx-enterprise/pull/1792) (alex-sheehan-edx)
- 2023-07-21 [feat: create cea for invite only courses before checkout](https://github.com/openedx/edx-enterprise/pull/1813) (tecoholic) [*open-source-contribution*]
...
- 2023-10-11 [Replacing non encrypted fields of blackboard config model with encrypted ones.](https://github.com/openedx/edx-enterprise/pull/1909) (MueezKhan246)

### [#](#-openedxenterprise-access) [openedx/enterprise-access](https://github.com/openedx/enterprise-access/pulls)
- 2023-11-02 [TOX 40 updates.](https://github.com/openedx/enterprise-access/pull/315) (zubairshakoorarbisoft)

### [#](#-openedxenterprise-catalog) [openedx/enterprise-catalog](https://github.com/openedx/enterprise-catalog/pulls)
...
- 2020-12-03 [feat: bpant/refactor to new redux libs](https://github.com/openedx/frontend-app-admin-portal/pull/395) (binodpant)
- 2021-07-16 [docs: PR template for Paragon work](https://github.com/openedx/frontend-app-admin-portal/pull/596) (binodpant)
...
- 2023-08-28 [refactor: updated lock file version check to use new workflow](https://github.com/openedx/frontend-app-admin-portal/pull/1023) (Mashal-m)
- 2023-09-12 [WIP: feat: Conditionally filter the budget enrollments](https://github.com/openedx/frontend-app-admin-portal/pull/1028) (zamanafzal)
- 2023-09-20 [Ammar/eahmadjaved/ent 7672 7673](https://github.com/openedx/frontend-app-admin-portal/pull/1036) (muhammad-ammar)
- 2023-10-14 [feat!: remove Transifex calls for OEP-58 \| FC-0012](https://github.com/openedx/frontend-app-admin-portal/pull/1060) (hopewise) [*open-source-contribution; blocked by other work*]
- 2023-10-25 [fix: use multiple analytics card messages](https://github.com/openedx/frontend-app-admin-portal/pull/1067) (brian-smith-tcril)
...
- 2022-01-24 [Removed Dead Code](https://github.com/openedx/frontend-app-learner-portal-enterprise/pull/434) (manny-m)
- 2022-07-21 [chore: override react/prop-types rule for test files](https://github.com/openedx/frontend-app-learner-portal-enterprise/pull/589) (long74100)
- 2023-01-11 [feat: ENT-6462](https://github.com/openedx/frontend-app-learner-portal-enterprise/pull/669) (sameenfatima78)
- 2023-04-04 [build: Add typescript support](https://github.com/openedx/frontend-app-learner-portal-enterprise/pull/703) (marlonkeating)
- 2023-06-27 [Add typescript support and migrate function example](https://github.com/openedx/frontend-app-learner-portal-enterprise/pull/782) (marlonkeating)
- 2023-08-03 [WIP: Feature branch for Skills Quiz V2](https://github.com/openedx/frontend-app-learner-portal-enterprise/pull/803) (zamanafzal)
- 2023-08-28 [refactor: updated lock file version check to use new workflow](https://github.com/openedx/frontend-app-learner-portal-enterprise/pull/813) (Mashal-m)
- 2023-08-29 [feat: added dropdowns for v2](https://github.com/openedx/frontend-app-learner-portal-enterprise/pull/815) (zamanafzal)
- 2023-10-30 [feat: upgrade react router to v6](https://github.com/openedx/frontend-app-learner-portal-enterprise/pull/861) (Syed-Ali-Abbas-Zaidi)
- 2023-11-02 [chore: use AppContext to fetch users metadata](https://github.com/openedx/frontend-app-learner-portal-enterprise/pull/865) (Syed-Ali-Abbas-Zaidi)

### [#](#-openedxfrontend-enterprise) [openedx/frontend-enterprise](https://github.com/openedx/frontend-enterprise/pulls)
- 2022-02-23 [feat: add key for suggestion items](https://github.com/openedx/frontend-enterprise/pull/223) (muneebGH)
- 2022-03-24 [build: add node 16 testing](https://github.com/openedx/frontend-enterprise/pull/239) (iamsobanjaved)
- 2022-04-12 [feat: remove feature flag for pathways](https://github.com/openedx/frontend-enterprise/pull/252) (muneebGH)
- 2023-08-28 [refactor: updated lock file version check to use new workflow](https://github.com/openedx/frontend-enterprise/pull/355) (Mashal-m)
- 2023-09-29 [Kiram15/backport take 2](https://github.com/openedx/frontend-enterprise/pull/362) (kiram15)
- 2023-10-17 [feat: bumped frontend-platform to v6](https://github.com/openedx/frontend-enterprise/pull/364) (BilalQamar95)

### [#](#-openedxlicense-manager) [openedx/license-manager](https://github.com/openedx/license-manager/pulls)
- 2023-10-05 [Revert "feat!: Upgrade to Django 4.2"](https://github.com/openedx/license-manager/pull/531) (iamsobanjaved)

## Team 2u-tnl

### [#](#-openedxfrontend-app-course-authoring) [openedx/frontend-app-course-authoring](https://github.com/openedx/frontend-app-course-authoring/pulls)
- 2023-08-09 [feat!: configure zoom live conference calls settings if exists at organization level](https://github.com/openedx/frontend-app-course-authoring/pull/555) (Faraz32123)
- 2023-08-28 [refactor: updated lock file version check to use new workflow](https://github.com/openedx/frontend-app-course-authoring/pull/579) (Mashal-m) [*jira:2u*]
- 2023-09-06 [feat: add support for design tokens and CSS variables](https://github.com/openedx/frontend-app-course-authoring/pull/590) (xitij2000) [*open-source-contribution*]
- 2023-09-18 [fix: Fixed card with longer texts](https://github.com/openedx/frontend-app-course-authoring/pull/605) (germanolleunlp)
- 2023-10-16 [feat!: remove Transifex calls for OEP-58 \| FC-0012](https://github.com/openedx/frontend-app-course-authoring/pull/627) (hopewise) [*blocked by other work; open-source-contribution*]
- 2023-10-17 [Convert "Pages & Resources" page to a plugin system](https://github.com/openedx/frontend-app-course-authoring/pull/638) (bradenmacdonald) [*open-source-contribution*]
...
- 2023-08-28 [refactor: updated lock file version check to use new workflow](https://github.com/openedx/frontend-app-library-authoring/pull/288) (Mashal-m)
- 2023-10-21 [feat!: remove Transifex calls for OEP-58 \| FC-0012](https://github.com/openedx/frontend-app-library-authoring/pull/351) (hopewise) [*blocked by other work; waiting on author; open-source-contribution*]
- 2023-10-26 [feat: upgrade mathjax from v2 to v3](https://github.com/openedx/frontend-app-library-authoring/pull/352) (navinkarkera) [*waiting on author; open-source-contribution; core contributor; jira:2u*]

### [#](#-openedxfrontend-lib-content-components) [openedx/frontend-lib-content-components](https://github.com/openedx/frontend-lib-content-components/pulls)
- 2023-07-24 [build: update frontend-build](https://github.com/openedx/frontend-lib-content-components/pull/364) (Mashal-m)
- 2023-08-08 [feat: game editor frontend](https://github.com/openedx/frontend-lib-content-components/pull/371) (tpreston2u)
- 2023-08-28 [refactor: updated lock file version check to use new workflow](https://github.com/openedx/frontend-lib-content-components/pull/381) (Mashal-m)
- 2023-11-02 [fix: Show advanced settings button color](https://github.com/openedx/frontend-lib-content-components/pull/417) (Lunyachek) [*open-source-contribution*]

### [#](#-openedxopaque-keys) [openedx/opaque-keys](https://github.com/openedx/opaque-keys/pulls)
- 2017-03-03 [ENT-211 add course key v2](https://github.com/openedx/opaque-keys/pull/87) (zubair-arbi)
- 2020-07-16 [Enable warnings.](https://github.com/openedx/opaque-keys/pull/136) (awais786)
- 2022-01-18 [chore: add reserved keywords linter](https://github.com/openedx/opaque-keys/pull/215) (arbabkhalil)

### [#](#-openedxstudio-frontend) [openedx/studio-frontend](https://github.com/openedx/studio-frontend/pulls)
- 2022-04-12 [QA: fix: Paragon updates for bd-39 testing](https://github.com/openedx/studio-frontend/pull/338) (muselesscreator)
- 2023-03-21 [feat: upgraded to node v18, added .nvmrc and updated workflows](https://github.com/openedx/studio-frontend/pull/376) (Mashal-m)
- 2023-10-14 [feat!: remove Transifex calls for OEP-58 \| FC-0012](https://github.com/openedx/studio-frontend/pull/383) (hopewise) [*open-source-contribution; blocked by other work*]

### [#](#-openedxxblock) [openedx/xblock](https://github.com/openedx/xblock/pulls)
- 2023-10-19 [[DEPR] xblock.fragment and direct id_generator parameters in xblock.runtime.Runtime](https://github.com/openedx/XBlock/pull/680) (irtazaakram)

## Team 2u-vanguards

### [#](#-openedxedx-ace) [openedx/edx-ace](https://github.com/openedx/edx-ace/pulls)
- 2022-01-25 [chore: add reserved keywords linter](https://github.com/openedx/edx-ace/pull/131) (arbabkhalil)
- 2023-10-31 [chore: Added tox<4.0.0 to constraints.txt](https://github.com/openedx/edx-ace/pull/243) (thezaeemaanwar)

### [#](#-openedxfrontend-app-authn) [openedx/frontend-app-authn](https://github.com/openedx/frontend-app-authn/pulls)
...
- 2023-10-21 [feat!: remove Transifex calls for OEP-58 \| FC-0012](https://github.com/openedx/frontend-app-authn/pull/1085) (hopewise) [*blocked by other work; open-source-contribution*]
- 2023-10-21 [fix: Prevent wrong appearance of skeleton after second tab click](https://github.com/openedx/frontend-app-authn/pull/1086) (Lunyachek) [*open-source-contribution*]
- 2023-10-27 [feat: unification of the appearance of buttons](https://github.com/openedx/frontend-app-authn/pull/1090) (ihor-romaniuk) [*open-source-contribution; waiting for eng review; backport*]
- 2023-10-27 [feat: unification of the appearance of buttons](https://github.com/openedx/frontend-app-authn/pull/1091) (ihor-romaniuk) [*open-source-contribution; waiting for eng review; backport*]
- 2023-10-27 [feat: unification of the appearance of buttons](https://github.com/openedx/frontend-app-authn/pull/1092) (ihor-romaniuk) [*waiting on author; open-source-contribution*]
- 2023-10-30 [chore: bumped frontend-platform to v6](https://github.com/openedx/frontend-app-authn/pull/1097) (BilalQamar95)
